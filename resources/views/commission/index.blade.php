    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-void-card border border-void-border rounded-2xl overflow-hidden
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3
                            ...
                            <span class="text-[10px] font-bold tracking-widest uppercase
                                         border px-3 py-1 rounded-full {{ $colorClass }}">
                        ...
                        <div class="px-5 py-4 flex flex-col sm:flex-row gap-4">
                            ...
                            @if($commission->reference_image_url)
                                <div class="w-full sm:w-24 h-24 rounded-xl overflow-hidden
                                            bg-void-dark shrink-0">
                                    <img src="{{ $commission->reference_image_url }}"
                                         alt="Referensi"
                                         class="w-full h-full object-cover">
                                </div>
                            @else
                                <div class="hidden sm:flex w-24 h-24 rounded-xl bg-void-dark shrink-0
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-void-gray line-clamp-2 leading-relaxed">
                                ...
                                @if($commission->admin_note)
                                    <div class="mt-3 p-3 bg-void-dark rounded-xl border border-void-border">
                                        <p class="text-[10px] font-bold text-void-gray uppercase tracking-wider mb-1">
                                            Catatan Admin
                                        </p>
                                        <p class="text-xs text-void-light leading-relaxed">
                        ...
                        <div class="px-5 py-3 border-t border-void-border bg-void-darker
                            ...
                            <a href="{{ route('commission.show', $commission) }}"
                               class="text-xs font-semibold text-void-light hover:text-void-accent transition-colors
        ...
        @else
            <div class="flex flex-col items-center justify-center py-24 text-center">
                ...
                <a href="{{ route('commission.create') }}" class="btn-primary">
                    Buat Commission Request
                </a>
            </div>
        @endif
    </div>
