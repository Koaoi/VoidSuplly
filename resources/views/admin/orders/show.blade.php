...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="bg-void-card border border-void-border rounded-2xl overflow-hidden">
            ...
            <div class="px-5 py-4 border-t border-void-border bg-void-darker space-y-2">
        ...
        <div class="bg-void-card border border-void-border rounded-2xl p-6">
            ...
            <form method="POST" action="{{ route('admin.orders.status',$order) }}"
                ...
                @if(in_array($order->status,['pending','paid']) && $order->payment)
    ...
    <div class="space-y-5">
        ...
        <div class="bg-void-card border border-void-border rounded-2xl p-5">
            ...
            <div class="flex items-center gap-3 mb-3">
                <img src="{{ $order->user->avatar_url }}" class="w-10 h-10 rounded-full object-cover border border-void-border">
                <div>
            ...
            <div class="bg-void-card border border-void-border rounded-2xl p-5">
                ...
                <div class="space-y-2 text-xs">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="{{ $order->payment->status==='paid' ? 'text-green-400' : 'text-yellow-400' }} font-bold capitalize">
